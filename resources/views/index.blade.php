<x-app-layout>
    ...
    {{--                <div class="mt-8">--}}
    {{--                    <button--}}
    {{--                        class="w-20 bg-gray-200 border border-gray-200 hover:border-gray-400 font-bold text-xxs--}}
    ...
    {{--                        >--}}
    {{--                            <div--}}
    {{--                                class="bg-gray-200 text-xxs font-bold uppercase leading-none rounded-full--}}
    ...
    {{--                                <svg fill="currentColor" width="24" height="6">--}}
    {{--                                    <path--}}
    {{--                                        d="M2.97.061A2.969 2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0--}}
    {{--                                        100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97--}}
    {{--                                         2.97 0 10-.003 5.94A2.97 2.97 0 0021.03.06z"--}}
    ...
    {{--                <div class="mt-8">--}}
    {{--                    <button--}}
    {{--                        class="w-20 bg-blue text-white border border-blue hover:bg-blue-hover font-bold text-xxs--}}
    {{--                         uppercase rounded-xl transition duration-150 ease-in px-4 py-3">--}}
    {{--                        Voted--}}
    {{--                    </button>--}}
    {{--                </div>--}}
    ...
    {{--                        reprehenderit earum--}}
    {{--                        incidunt. Ad reprehenderit repudiandae dolorem ducimus modi accusamus beatae--}}
    {{--                        perferendis? Eum--}}
    {{--                        eligendi nulla aliquam numquam! Nobis, tempore rerum autem accusamus--}}
    {{--                        perspiciatis laudantium at--}}
    {{--                        excepturi sint placeat nulla beatae qui aliquam quibusdam corrupti vel dolor--}}
    {{--                        praesentium quam--}}
    {{--                        dolore itaque deleniti quod in ut earum. Cum fuga ea molestias nesciunt--}}
    {{--                        soluta--}}
    {{--                        sint maxime,--}}
    {{--                        magnam dolorum reprehenderit autem, vel ipsa? Vitae vel quos quaerat, fugit--}}
    {{--                        in--}}
    {{--                        reiciendis alias--}}
    {{--                        perspiciatis esse numquam facere cum veniam beatae voluptatem eos amet vero--}}
    {{--                        laborum error. Dolor--}}
    ...
    {{--                            <div--}}
    {{--                                class="bg-yellow text-white text-xxs font-bold uppercase leading-none rounded-full--}}
    {{--                                 text-center w-28 h-7 py-2 px-4">--}}
    {{--                                In Progress--}}
    {{--                            </div>--}}
    {{--                            <button--}}
    ...
    {{--                                    <path--}}
    {{--                                        d="M2.97.061A2.969 2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0--}}
    {{--                                        100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97 2.97 0 10-.003 5.94A2.97 2.97 0 0021.03.06z"--}}
    {{--                                        style="color: rgba(163, 163, 163, .5)"></path>--}}
    {{--                                </svg>--}}
    {{--                                <ul class="hidden absolute w-44 text-left font-semibold bg-white shadow-dialog--}}
    {{--                                 rounded-xl py-3 ml-8">--}}
    {{--                                    <li>--}}
    {{--                                        <a href="#"--}}
    {{--                                           class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">--}}
    {{--                                            Mark as Spam--}}
    ...
    {{--                        <div class="flex items-center space-x-2">--}}
    {{--                            <div--}}
    {{--                                class="bg-red text-white text-xxs font-bold uppercase leading-none rounded-full--}}
    {{--                                 text-center w-28 h-7 py-2 px-4">--}}
    {{--                                Closed--}}
    {{--                            </div>--}}
    {{--                            <button--}}
    {{--                                class="relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150--}}
    {{--                                 ease-in py-2 px-3">--}}
    {{--                                <svg fill="currentColor" width="24" height="6">--}}
    {{--                                    <path--}}
    {{--                                        d="M2.97.061A2.969 2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0--}}
    ...
    {{--                        <div class="flex items-center space-x-2">--}}
    {{--                            <div--}}
    {{--                                class="bg-green text-white text-xxs font-bold uppercase leading-none rounded-full--}}
    {{--                                 text-center w-28 h-7 py-2 px-4">--}}
    {{--                                Implemented--}}
    {{--                            </div>--}}
    {{--                            <button--}}
    ...
    {{--                        <div class="flex items-center space-x-2">--}}
    {{--                            <div--}}
    {{--                                class="bg-purple text-white text-xxs font-bold uppercase leading-none rounded-full--}}
    {{--                                 text-center w-28 h-7 py-2 px-4">--}}
    {{--                                Considering--}}
    {{--                            </div>--}}
    {{--                            <button--}}
