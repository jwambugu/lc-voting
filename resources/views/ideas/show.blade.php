<x-app-layout>
    <div>
        <a href="{{ route('ideas.index') }}" class="flex items-center font-semibold hover:underline">
        ...
        <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    >
                        <div
                            class="{{ $idea->status->classes }} text-xxs font-bold uppercase leading-none rounded-full
